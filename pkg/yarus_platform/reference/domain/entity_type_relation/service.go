...
type IService interface {
	NewEntity() *EntityTypeRelation
	Get(ctx context.Context, id uint) (*EntityTypeRelation, error)
	Query(ctx context.Context, query *selection_condition.SelectionCondition) ([]EntityTypeRelation, error)
...
func (s *service) NewEntity() *EntityTypeRelation {
	return New()
}

// Get returns the entity with the specified ID.
func (s *service) Get(ctx context.Context, id uint) (*EntityTypeRelation, error) {
...
func (s *service) Query(ctx context.Context, cond *selection_condition.SelectionCondition) ([]EntityTypeRelation, error) {
...
func (s *service) Create(ctx context.Context, entity *EntityTypeRelation) error {
	err := entity.Validate()
	if err != nil {
...
func (s *service) Update(ctx context.Context, entity *EntityTypeRelation) error {
	err := entity.Validate()
	if err != nil {
		return errors.Wrapf(err, "Validation error: %v", err)
	}
...
func (s *service) Save(ctx context.Context, entity *EntityTypeRelation) error {
	err := entity.Validate()
	if err != nil {
		return errors.Wrapf(err, "Validation error: %v", err)
	}
