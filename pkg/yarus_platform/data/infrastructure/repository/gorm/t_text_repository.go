...
var _ text_value.Repository = (*TTextRepository)(nil)
...
func (r *TTextRepository) Get(ctx context.Context, id uint) (*text_value.TextValue, error) {
...
func (r *TTextRepository) First(ctx context.Context, entity *text_value.TextValue) (*text_value.TextValue, error) {
...
func (r *TTextRepository) Query(ctx context.Context, cond *selection_condition.SelectionCondition) ([]text_value.TextValue, error) {
...
func (r *TTextRepository) Create(ctx context.Context, entity *text_value.TextValue) error {
...
func (r *TTextRepository) Update(ctx context.Context, entity *text_value.TextValue) error {
...
func (r *TTextRepository) Save(ctx context.Context, entity *text_value.TextValue) error {
