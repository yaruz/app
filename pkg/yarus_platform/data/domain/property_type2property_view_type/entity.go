...
type PropertyType2PropertyViewType struct {
	PropertyTypeID     uint       `sql:"type:bigint not null REFERENCES \"property_type\"(id)" gorm:"primaryKey" json:"propertyTypeID"`
	PropertyViewTypeID uint       `sql:"type:bigint not null REFERENCES \"property_view_type\"(id)" gorm:"primaryKey" json:"propertyViewTypeID"`
