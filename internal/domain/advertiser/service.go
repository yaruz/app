...
func (s *service) New(ctx context.Context) (*Advertiser, error) {
	return s.repository.New(ctx)
}

// Get returns the entity with the specified ID.
func (s *service) Get(ctx context.Context, id uint, langID uint) (*Advertiser, error) {
...
func (s *service) Query(ctx context.Context, condition *selection_condition.SelectionCondition, langID uint) ([]Advertiser, error) {
	return s.repository.Query(ctx, condition, langID)
}

func (s *service) First(ctx context.Context, condition *selection_condition.SelectionCondition, langID uint) (*Advertiser, error) {
...
func (s *service) Create(ctx context.Context, obj *Advertiser, langID uint) error {
	return s.repository.Create(ctx, obj, langID)
}

func (s *service) Update(ctx context.Context, obj *Advertiser, langID uint) error {
