...
type IService interface {
	...
	Query(ctx context.Context, query *selection_condition.SelectionCondition) ([]Mark, error)
}
...
func (s service) Query(ctx context.Context, query *selection_condition.SelectionCondition) ([]Mark, error) {
